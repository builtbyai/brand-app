...
export default function PromptSuggest({
  ...
  return (
    <button
      ...
      title="AI suggest"
      className={`flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded border border-nw-bronze/30 text-nw-bronze hover:bg-nw-bronze/10 disabled:opacity-50 ${className ?? ""}`}
    >
