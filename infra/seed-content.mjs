 ...
 *   wrangler d1 execute brand-os-prod --remote --file=../infra/.seed-content.sql
 */
...
async function main() {
  ...
  const out = [];
  out.push("-- Seed content for brand-os.");

  for (const a of articles) {
    const urn = `urn:brand-os-seed:${a.id}`;
  ...
  const defaultSources = [
    { id: "src_northwind_blog", kind: "rss", url: "https://example.com/feed.xml", label: "Northwind Blog", category: "Guides", badge: "Article" },
    { id: "src_reddit_productivity", kind: "reddit", url: "https://www.reddit.com/r/productivity/.json", label: "r/productivity (hot)", category: "Trends", badge: "Article" },
    { id: "src_reddit_saas", kind: "reddit", url: "https://www.reddit.com/r/SaaS/.json", label: "r/SaaS (hot)", category: "Trends", badge: "Article" },
    { id: "src_google_news_saas", kind: "rss", url: "https://news.google.com/rss/search?q=team+productivity+software&hl=en-US&gl=US&ceid=US:en", label: "Google News — Productivity Software", category: "News", badge: "Article" },
  ];
